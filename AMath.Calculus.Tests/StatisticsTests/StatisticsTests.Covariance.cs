using AMath.Calculus.Statistic.Implementation;
using System;
...
namespace AMath.Calculus.Tests.StatisticsTests
{
    public partial class StatisticsTests
    {
        ...
        {
            var covariance = new Statistics().Covariance(TestData_1, TestData_2, Statistic.CovarianceType.Population);
        ...
        {
            var covariance = new Statistics().Covariance(TestData_1, TestData_2, Statistic.CovarianceType.Sample);
        ...
        {
            var covariance = new Statistics().Covariance(TestData_3, TestData_4, Statistic.CovarianceType.Population);
        ...
        {
            var covariance = new Statistics().Covariance(TestData_3, TestData_4, Statistic.CovarianceType.Sample);
        ...
        public void StandartDeviation()
        {
            ...
            var result = new Statistics().StandardDeviation(TestData_1);
        ...
        public void StandartDeviationAdvanced()
        {
            ...
            var result = new Statistics().StandardDeviation(TestData_3);
            Assert.That(Math.Round(expected, 3) == Math.Round(result, 3));
        }
        ...
        {
            var expected = 1;
            var result = new Statistics().Corellation(TestData_1, TestData_2);
        ...
        {
            var expected = 0.927m;
            var result = new Statistics().Corellation(TestData_3, TestData_4);
        ...
        {
            var expected = 2.5m;
            var result = new Statistics().Variance(TestData_1);
            Assert.That(result == expected);
        }
        [Test]
        public void VarianceAdvanced()
        {
            ...
            var result = new Statistics().Variance(TestData_3);
